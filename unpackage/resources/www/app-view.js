...
var oX=_mz(z,'button',['bindtap',19,'class',1,'data-event-opts',2,'type',3],[],hU,cT,gg)
...
oR.wxXCkey=2
_2z(z,17,fS,e,s,gg,oR,'value','key','key')
cs.pop()
cs.pop()
_(oD,xQ)
cs.pop()
...
var aZ=_mz(z,'navigator',['hoverClass',24,'url',1],[],e,s,gg)
cs.push("./pages/API/api.wxml:button:1:989")
var t1=_n('button')
_rz(z,t1,'type',26,e,s,gg)
...
cs.pop()
_(oB,aZ)
cs.push("./pages/API/api.wxml:navigator:1:1051")
var b3=_mz(z,'navigator',['hoverClass',28,'url',1],[],e,s,gg)
cs.push("./pages/API/api.wxml:button:1:1119")
var o4=_n('button')
_rz(z,o4,'type',30,e,s,gg)
...
var xIB=_mz(z,'image',['class',11,'src',1],[],e,s,gg)
cs.pop()
_(oHB,xIB)
cs.pop()
_(oBB,oHB)
...
var fKB=_mz(z,'button',['bindtap',14,'data-event-opts',1,'type',2],[],e,s,gg)
var cLB=_oz(z,17,e,s,gg)
_(fKB,cLB)
cs.pop()
_(oJB,fKB)
cs.push("./pages/getuser/getuser.wxml:button:1:724")
var hMB=_mz(z,'button',['bindtap',18,'data-event-opts',1],[],e,s,gg)
...
var cZB=_n('view')
_rz(z,cZB,'class',8,eTB,tSB,gg)
cs.push("./pages/index/index.wxml:text:1:197")
var h1B=_n('text')
var o2B=_oz(z,9,eTB,tSB,gg)
_(h1B,o2B)
cs.pop()
_(cZB,h1B)
cs.pop()
_(fYB,cZB)
cs.push("./pages/index/index.wxml:view:1:237")
var c3B=_n('view')
_rz(z,c3B,'class',10,eTB,tSB,gg)
cs.push("./pages/index/index.wxml:text:1:270")
var o4B=_n('text')
var l5B=_oz(z,11,eTB,tSB,gg)
_(o4B,l5B)
cs.pop()
_(c3B,o4B)
cs.pop()
...
var a6B=_n('view')
_rz(z,a6B,'class',12,eTB,tSB,gg)
cs.push("./pages/index/index.wxml:image:1:338")
var t7B=_mz(z,'image',['binderror',13,'class',1,'data-event-opts',2,'mode',3,'src',4,'style',5],[],eTB,tSB,gg)
cs.pop()
_(a6B,t7B)
cs.pop()
_(xWB,a6B)
...
lQB.wxXCkey=2
_2z(z,4,aRB,e,s,gg,lQB,'item','__i0__','')
cs.pop()
cs.pop()
_(r,oPB)
return r
...
var z=gz$gwx_4()
cs.push("./pages/upload/uploadfile.wxml:view:1:1")
var b9B=_n('view')
_rz(z,b9B,'bind:__l',0,e,s,gg)
cs.push("./pages/upload/uploadfile.wxml:page-head:1:22")
var o0B=_n('page-head')
_rz(z,o0B,'title',1,e,s,gg)
cs.pop()
_(b9B,o0B)
cs.push("./pages/upload/uploadfile.wxml:view:1:63")
var xAC=_n('view')
_rz(z,xAC,'class',2,e,s,gg)
cs.push("./pages/upload/uploadfile.wxml:view:1:108")
var oBC=_n('view')
_rz(z,oBC,'class',3,e,s,gg)
var fCC=_v()
_(oBC,fCC)
if(_oz(z,4,e,s,gg)){fCC.wxVkey=1
cs.push("./pages/upload/uploadfile.wxml:block:1:127")
cs.push("./pages/upload/uploadfile.wxml:block:1:155")
cs.push("./pages/upload/uploadfile.wxml:image:1:162")
var cDC=_mz(z,'image',['class',5,'mode',1,'src',2],[],e,s,gg)
cs.pop()
_(fCC,cDC)
cs.pop()
cs.pop()
...
cs.push("./pages/upload/uploadfile.wxml:block:1:242")
cs.push("./pages/upload/uploadfile.wxml:block:1:257")
cs.push("./pages/upload/uploadfile.wxml:view:1:264")
