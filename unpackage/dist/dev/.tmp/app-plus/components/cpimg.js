    ...
    _cpImg: function _cpImg(resPath) {
      ...
      uni.getImageInfo({
        ...
        success: function success(image) {
          console.log(image.width, " at components\\cpimg.vue:78");
          console.log(image.height, " at components\\cpimg.vue:79");
        ...
        ctx.draw(false, function () {
          ...
          setTimeout(function () {
            uni.canvasToTempFilePath({
              ...
              success: function success(res) {
                console.log("图片" + res.tempFilePath, " at components\\cpimg.vue:168");
...
;(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
    'components/cpimg-create-component',
    {
        'components/cpimg-create-component':(function(module, exports, __webpack_require__){
            __webpack_require__('./node_modules/@dcloudio/uni-app-plus/dist/index.js')['createComponent'](__webpack_require__("E:\\Desktop\\uni-app\\project1\\components\\cpimg.vue"))
        })
    },
    [['components/cpimg-create-component']]
]);                
