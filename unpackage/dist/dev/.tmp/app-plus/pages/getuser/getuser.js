...

{
  ...
  methods: {
    ...
    getUserInfo: function getUserInfo() {var _this = this;
      uni.getUserInfo({
        ...
        success: function success(result) {
          console.log('getUserInfo success', result, " at pages\\getuser\\getuser.vue:55");
          _this.hasUserInfo = true;
          _this.userInfo = result.userInfo;
        },
        fail: function fail(error) {
          console.log('getUserInfo fail', error, " at pages\\getuser\\getuser.vue:60");
    ...
    mpGetUserInfo: function mpGetUserInfo(result) {
      console.log('mpGetUserInfo', result, " at pages\\getuser\\getuser.vue:74");
