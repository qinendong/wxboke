      ...
      uni.downloadFile({
        ...
        success: function success(res) {
          if (res.statusCode === 200) {
            console.log('下载成功', " at pages\\QR_image\\qrimage.vue:32");
            console.log(res.tempFilePath, " at pages\\QR_image\\qrimage.vue:33");
    ...
    btn1: function btn1() {
      ...
      uni.saveImageToPhotosAlbum({
        ...
        success: function success() {
          console.log('save success', " at pages\\QR_image\\qrimage.vue:47");
          uni.hideLoading();
        } });
