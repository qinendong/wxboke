...
var _index = __webpack_require__(/*! @/node_modules/image-tools/index.js */ "E:\\Desktop\\uni-app\\project1\\node_modules\\image-tools\\index.js");var cpimg = function cpimg() {return __webpack_require__.e(/*! import() | components/cpimg */ "components/cpimg").then(__webpack_require__.bind(null, /*! @/components/cpimg.vue */ "E:\\Desktop\\uni-app\\project1\\components\\cpimg.vue"));};var _default =
{
  ...
  methods: {
    radioChange: function radioChange(evt) {
      //选择尺寸
      console.log(evt.detail.value, " at pages\\Face_recognition\\Face_registration.vue:80");
      this.inch = evt.detail.value;
    },
    radioChange1: function radioChange1(evt) {
      //选择底色
      console.log(evt.detail.value, " at pages\\Face_recognition\\Face_registration.vue:85");
    ...
    baocun: function baocun() {
      ...
      then(function (path) {
        console.log(path, " at pages\\Face_recognition\\Face_registration.vue:94");
        uni.saveImageToPhotosAlbum({
          filePath: path,
          success: function success() {
            console.log('save success', " at pages\\Face_recognition\\Face_registration.vue:98");
            uni.hideLoading();
        ...
        console.error(error, " at pages\\Face_recognition\\Face_registration.vue:105");
      });
    },
    cpimgWH: function cpimgWH(w, h) {
      console.log("阿斯顿撒" + w, " at pages\\Face_recognition\\Face_registration.vue:109");
      console.log("阿斯顿撒" + h, " at pages\\Face_recognition\\Face_registration.vue:110");
      this.w = w;
      this.h = h;
    },
    cpimgPath: function cpimgPath(path) {
      console.log('tu片' + path, " at pages\\Face_recognition\\Face_registration.vue:115");
      this.path = path;
    },
    // 添加图片
    ...
    cpimgOk: function cpimgOk(file) {var _this = this;
      ...
      uni.request({
        ...
        success: function success(res) {
          ...
          console.log(res.data, " at pages\\Face_recognition\\Face_registration.vue:146");
          _this.data = res.data;
          uni.hideLoading();
    ...
    cpimgErr: function cpimgErr(e) {
      console.log(e, " at pages\\Face_recognition\\Face_registration.vue:155");
    } },
