...
var requestNum = 0;var _default =
{
  ...
  methods: {
    ...
    btn: function btn() {var _this = this;
      ...
      console.log(this.my, " at pages\\voice\\voice1.vue:85");
      uni.request({
        ...
        success: function success(res) {
          console.log(res, " at pages\\voice\\voice1.vue:96");
    ...
    startRecord: function startRecord() {
      console.log('开始录音', " at pages\\voice\\voice1.vue:124");
    ...
    endRecord: function endRecord() {
      console.log('录音结束', " at pages\\voice\\voice1.vue:131");
    ...
    onstop: function onstop() {
      ...
      recorderManager.onStop(function (res) {
        ...
        console.log(res.tempFilePath, " at pages\\voice\\voice1.vue:140");
        uni.uploadFile({
          ...
          success: function success(uploadFileRes) {
            ...
            console.log(JSON.parse(JSON.parse(uploadFileRes.data).path), " at pages\\voice\\voice1.vue:150");
    ...
    playVoice: function playVoice() {
      console.log('播放录音' + this.voicePath, " at pages\\voice\\voice1.vue:165");
    ...
    yuhc: function yuhc(value) {
      console.log(1, " at pages\\voice\\voice1.vue:173");
      uni.request({
        ...
        success: function success(res) {
          console.log(res.data.path, " at pages\\voice\\voice1.vue:184");
