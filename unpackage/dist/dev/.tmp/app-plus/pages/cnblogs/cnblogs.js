  ...
  onLoad: function onLoad(option) {var _this = this;
    uni.request({
      ...
      success: function success(res) {
        console.log(res.data.json, " at pages\\cnblogs\\cnblogs.vue:60");
        _this.items = res.data.json;
        _this.bkylist = JSON.parse(_this.items).feed.entry;
        console.log(JSON.parse(_this.items).feed.entry, " at pages\\cnblogs\\cnblogs.vue:63");
      } });

    console.log(option.id, " at pages\\cnblogs\\cnblogs.vue:66"); //打印出上个页面传递的参数。
    console.log(option.name, " at pages\\cnblogs\\cnblogs.vue:67"); //打印出上个页面传递的参数。
  ...
  methods: {
    ...
    getmorenews: function getmorenews() {var _this3 = this;
      uni.request({
        ...
        success: function success(res) {
          page++;
          console.log(page, " at pages\\cnblogs\\cnblogs.vue:128");
          //console.log(res.data.json)
          _this3.items = res.data.json;
          _this3.bkylist = _this3.bkylist.concat(JSON.parse(_this3.items).feed.entry);
          console.log(JSON.parse(res.data.json).feed.entry, " at pages\\cnblogs\\cnblogs.vue:132");
          //uni.hideLoading();
        } });
    ...
    geturl: function geturl(url) {
      ...
      //console.log(str)
      console.log(str1 + str, " at pages\\cnblogs\\cnblogs.vue:148");
      return str1 + str;
    },
