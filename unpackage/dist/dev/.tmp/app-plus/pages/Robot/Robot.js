...
var requestNum = 0;var _default =
{
  ...
  methods: {
    ...
    btn: function btn() {var _this = this;
      ...
      console.log(this.my, " at pages\\Robot\\Robot.vue:54");
      uni.request({
        ...
        success: function success(res) {
          console.log(res.data, " at pages\\Robot\\Robot.vue:65");
    ...
    yuhc: function yuhc(value) {
      console.log(1, " at pages\\Robot\\Robot.vue:90");
      uni.request({
        ...
        success: function success(res) {
          console.log(res.data.path, " at pages\\Robot\\Robot.vue:101");
