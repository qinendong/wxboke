...
var page = 1;var _default =
{
  ...
  methods: {
    ...
    loadNewsList: function loadNewsList(type) {var _this = this;
      ...
      if (type === 'add') {
        ...
        uni.request({
          ...
          success: function success(res) {
            page++;
            console.log(page, " at pages\\tabar\\tabar.vue:301");
            //console.log(res.data.json)
            _this.items = res.data.json;
            _this.bkylist = _this.bkylist.concat(JSON.parse(_this.items).feed.entry);
            console.log(JSON.parse(res.data.json).feed.entry, " at pages\\tabar\\tabar.vue:305");
            //uni.hideLoading();
          } });
        ...
        uni.request({
          ...
          success: function success(res) {
            page++;
            console.log(page, " at pages\\tabar\\tabar.vue:320");
            //console.log(res.data.json)
            _this.items = res.data.json;
            _this.bkylist1 = _this.bkylist1.concat(JSON.parse(_this.items).feed.entry);
            console.log(JSON.parse(res.data.json).feed.entry, " at pages\\tabar\\tabar.vue:324");
            //uni.hideLoading();
          } });
        ...
        uni.request({
          ...
          success: function success(res) {
            page++;
            console.log(page, " at pages\\tabar\\tabar.vue:339");
            //console.log(res.data.json)
            _this.items = res.data.json;
            _this.bkylist2 = JSON.parse(_this.items).feed.entry;
            console.log(JSON.parse(res.data.json).feed.entry, " at pages\\tabar\\tabar.vue:343");
            //uni.hideLoading();
          } });
      ...
      if (type === 'refresh') {
        ...
        uni.request({
          ...
          success: function success(res) {
            page++;
            console.log(page, " at pages\\tabar\\tabar.vue:363");
            //console.log(res.data.json)
            _this.items = res.data.json;
    ...
    changeTab: function () {var _changeTab = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(e) {var _this2 = this;var index, tabBarScrollLeft, width, nowWidth, i, result;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                ...
                console.log(e, " at pages\\tabar\\tabar.vue:396");
                console.log(tabBar, " at pages\\tabar\\tabar.vue:397");
                if (scrollTimer) {
                  //多次切换只执行最后一次
